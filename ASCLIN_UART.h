...
void UART_PutChar(char ch);   //发送单个字符
void UART_PutStr(char *str);  //发送字符串
char UART_GetChar(void);      //接收单个字符
char UART_GetBuff(unsigned char *data); //获取UART缓存区数据
//void putStr(void *data , sint16 *count);
