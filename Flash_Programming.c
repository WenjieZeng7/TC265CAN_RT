...
#define DATA_TO_WRITE               0x12345678                  /* Dummy data to be written in the Flash memories   */
...
#define DFLASH_NUM_PAGE_TO_FLASH    1                           /* Number of pages to flash in the DFLASH           */ //֮ǰ�õ���8ҳҲû����
...
#define LED2                        &MODULE_P33,9               /* LED connected to Port 13, Pin 1                  */
 ...
 */
void writeDataFlash(uint32 ids)
{
    uint32 page;                                                /* Variable to cycle over all the pages             */
    ...
    for(page = 0; page < DFLASH_NUM_PAGE_TO_FLASH; page++)      /* Loop over all the pages                          */
    {
        ...
        IfxFlash_loadPage2X32(pageAddr, ids, ids); /* Load two words of 32 bits each            */
